      ...
      switch (filterType) {
        ...
        case "upcoming":
          filtered = allLetters.filter(
            (l: Letter) => l.due_date && new Date(l.due_date) > now && l.status !== "completed"
          );
          break;
        case "overdue":
          filtered = allLetters.filter(
          ...
          break;
        case "recurring":
          filtered = allLetters.filter((l: Letter) => {
            ...
            const isRecurring = hasRecurrenceType && hasRecurrenceValue;
          ...
          <Table>
            <TableHead>
              <TableRow sx={{ backgroundColor: "#1a237e" }}>
                <TableCell sx={{ color: "white", fontWeight: "bold" }}>Ref No</TableCell>
                <TableCell sx={{ color: "white", fontWeight: "bold" }}>Subject</TableCell>
                <TableCell sx={{ color: "white", fontWeight: "bold" }}>Sender Department</TableCell>
                <TableCell sx={{ color: "white", fontWeight: "bold" }}>Receiver Department</TableCell>
            ...
            <TableBody>
              {filteredLetters.length === 0 ? (
                  ...
                  <TableCell colSpan={9} align="center">
                    <Box sx={{ py: 6 }}>
                      <Typography variant="h6" color="text.secondary" sx={{ mb: 1 }}>
                        {searchTerm ? "No results found" : "No letters found"}
                      </Typography>
                      <Typography variant="body2" color="text.secondary">
                        {searchTerm 
                          ? "Try adjusting your search terms"
                          : filterType === "recurring" 
                          ? "No recurring letters available"
                          : filterType === "overdue"
                          ? "No overdue letters - great job!"
                          : filterType === "upcoming"
                          ? "No upcoming due letters"
                          : "Try adjusting your filters or create a new tasks"}
                      </Typography>
                    </Box>
                  </TableCell>
                </TableRow>
                ...
                filteredLetters.map((letter, index) => {
                  ...
                  const priorityColor = getPriorityColor(letter.priority);
